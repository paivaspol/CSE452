...
public class ReliableInOrderMsgLayer {
  ...
  private final HashMap<Integer, InChannel> inConnections;
  private final HashMap<Integer, OutChannel> outConnections;
  private final RIONode n;
...
class InChannel {
  ...
  private final HashMap<Integer, RIOPacket> outOfOrderMsgs;
...
class OutChannel {
  ...
  private final HashMap<Integer, RIOPacket> unACKedPackets;
  private int lastSeqNumSent;
  private final ReliableInOrderMsgLayer parent;
  private final int destAddr;

  private final HashMap<Integer, Integer> resendCounter;
  ...
  OutChannel(ReliableInOrderMsgLayer parent, int destAddr) {
    ...
    resendCounter = new HashMap<Integer, Integer>();
  }
