...
public class Utility {
  ...
  public static byte[] stringToByteArray(String msg) {
    try {
      ...
      System.err
          .println("Exception occured while converting string to byte array. String: " + msg + " Exception: " + e);
    }
    return null;
  }
  ...
  /**
   * Escapes a string to be suitable for inclusion on a synoptic log event line.
   * 
